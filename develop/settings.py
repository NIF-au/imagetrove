...
SECRET_KEY = 'ogheetooh1ea5PaiyoodieTh0Thaleengah9eesaeja1ohk1oh'
...
MIDDLEWARE_CLASSES = (
    ...
    # Following line caused: Your database backend doesn't behave properly when autocommit is off. Turn it on before using 'atomic'.
