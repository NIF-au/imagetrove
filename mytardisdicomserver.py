...
parser.add_argument('-aet', help='AE title of this server', default='ImageTrove')
...
def OnReceiveStore(SOPClass, DS):
    ...
    file_meta.MediaStorageSOPInstanceUID = "1.2.3"  # FIXME Need valid UID here
    file_meta.ImplementationClassUID = "1.2.3.4"  # FIXME Need valid UIDs here
    filename = '%s/%s.dcm' % ('/dicom_tmp', DS.SOPInstanceUID) # FIXME SOPInstanceUID isn't enough if we have multiple instruments?
